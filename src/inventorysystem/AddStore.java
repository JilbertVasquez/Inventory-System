...
public class AddStore extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        storeNickname = new javax.swing.JTextField();
        ...
        addOrderLabel.setText("ADD STORE");
        ...
        addSupplierTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STORE", "NICKNAME", "LOCATION", "DATE CREATED"
            }
        ) {
        ...
        storeNickname.setFont(new java.awt.Font("Nirmala UI Semilight", 1, 14)); // NOI18N
        storeNickname.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        storeNickname.setText("NICKAME");
        storeNickname.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                storeNicknameFocusGained(evt);
            }
        });
        jPanel1.add(storeNickname, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, 120, -1));
        ...
        storeName.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                storeNameFocusGained(evt);
            }
        });
        jPanel1.add(storeName, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 120, 120, -1));
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        String nickname = storeNickname.getText();
        ...
        try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/" + dbName, dbUsername, dbPassword)) {
            ...
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "Store already exist.", "Error", JOptionPane.ERROR_MESSAGE);
            }
            else {
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (selAll.length == 0) {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/" + dbName, dbUsername, dbPassword)) {
                String query = "INSERT INTO stores (storeName, storeNickname, storeLocation, username, storeCreated_at) VALUES (?, ?, ?, ?, ?)";
                PreparedStatement ps = con.prepareStatement(query);
    ...
    private void storeNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_storeNameFocusGained
        storeName.setText("");
    }//GEN-LAST:event_storeNameFocusGained

    private void storeNicknameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_storeNicknameFocusGained
        storeNickname.setText("");
    }//GEN-LAST:event_storeNicknameFocusGained
    ...
    private javax.swing.JTextField storeNickname;
